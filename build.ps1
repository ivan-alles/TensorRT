...
cmake .. -A x64 -G "Visual Studio 15 2017" -DTRT_OUT_DIR="../out" -DCMAKE_TOOLCHAIN_FILE="..\cmake\toolchains\cmake_x64_win.toolchain" -DCUBLASLT_LIB="C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.4\lib\x64\cublasLt.lib" -DCUBLAS_LIB="C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.4\lib\x64\cublas.lib" -DCUDART_LIB="C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.4\lib\x64\cudart.lib" -DCUDNN_LIB="C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.4\lib\x64\cudnn.lib"
