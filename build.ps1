...
# cmake .. -G "Visual Studio 15 2017"  -DTRT_LIB_DIR=$Env:TRT_LIBPATH -DTRT_OUT_DIR='..\out' -DCMAKE_TOOLCHAIN_FILE="..\cmake\toolchains\cmake_x64_win.toolchain" -DCUDA_VERISON="11.4.3" -DCUDA_TOOLKIT= -DCMAKE_CUDA_ARCHITECTURES=all -DCMAKE_SYSTEM_PROCESSOR="AMD64"
